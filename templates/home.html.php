...
<article>
	<p style="text-align: center;font-size: 30px;font-weight: bold;background-color: rgba(0, 0, 0, 0.9);padding: 1%;box-shadow: 2px 2px 7px black;border-radius: 4px 4px 4px 4px;">
		<img src ="images/cropped_Tshirt_Black_web.jpg" width="35%" title="Profile Photo" alt="Profile Photo"><br>
		<a style="color: grey;"href="#Contact_Info">Contact Me</a>
	</p>
</article>
	...
	<section style="border: 1px solid grey; padding: 2%;margin-bottom: 1%;">
		...
		<p>
			...
			<a href="https://coursera.org/share/92e8c57cd1f87bd963a9ce838014709f">
				<img src ="images/git-github.png" width="90%" title="Click image to load official Certificate Site." alt="git and github version control certificate from Google.">
			</a>
			<hr style="border:1px solid green">
		</p>
